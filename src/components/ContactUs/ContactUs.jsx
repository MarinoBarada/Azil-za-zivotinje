      ...
      <div className={style["contact"]}>
        ...
        <div className={style["contact-container"]}>
          <div className={style["info-container"]}>
            <p>Split, Hrvatska</p>
            <p>Telefon: <a href="tel:0919774088">+385-91-977-4088</a></p>
            <p>Email: <a href="mailto:marino18barada@gmail.com">marino18barada@gmail.com</a></p>
            <SocialIcons />
          </div>
          <form
          ...
          >
            ...
            {errors.mobile?.type === "pattern" && (
              <span>
                Broj mobitela morao izgledati kao npr. +385-985-245-1730 ili 091
                999 9999.
              </span>
            )}
            <input
